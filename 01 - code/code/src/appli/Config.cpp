...
//std::map < Config::Skins  , std::shared_ptr<gui::Skin >>    Config::ms_skins = {};
...
{
    Config::ms_polices.load( Polices::police_1   , "media/polices/arial.ttf"  );
    Config::ms_polices.load( Polices::police_2   , "media/polices/bgothl.ttf"  );
    Config::ms_polices.load( Polices::log        , "media/polices/consola.ttf"  );
}
...
{
    Config::ms_textures.load( Images::image_1   , "media/img/avatar 2.jpg"  );
    Config::ms_textures.load( Images::image_2   , "media/img/ico_fenetre.png" );
}
/////////////////////////////////////////////////
